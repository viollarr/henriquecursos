...
<link rel="stylesheet" type="text/css" href="dhtmlcombo_novo.css" >
...
***********************************************/
	...
	<div class="subMenu" style="display:inline;">
        ...
        <div class="subItem"><a href="home_nova.php">&nbsp;&nbsp;APRESENTAÇÃO</a></div>
		...
		$y = mysql_query("SELECT id, nome, novo FROM `cursos` ORDER BY nome ASC" );
		...
		elseif ($c == 1){
			...
			elseif(($x['nome'] != 'ERGONOMIA - MÓDULO BÁSICO') and ($x['nome'] != 'ERGONOMIA - MÓDULO AVANÇADO') and ($x['nome'] != 'SPA FACIAL') and ($x['nome'] != 'SPA CORPORAL') and ($x['nome'] != 'SPA GESTANTE') and ($x['nome'] != 'SPA RELAXAMENTO') and ($x['nome'] != 'SPA DOS PÉS')){
				...
				if($x['nome'] == 'MIX MASSAGEM TERAPIA'){
					...
					echo "<option title='$novo' value='cal_geral_nova.php?id=".$x[id]."' style='color:#FFFFFF !important;'>$x[nome]</option>'";

				}

				else{

					echo "<option title='$novo' value='cal_geral_nova.php?id=".$x[id]."' style='color:$color;'>$x[nome]</option>";
...
<script type="text/javascript">
 ...
 dhtmlselect("webmaster")
	    ...
	    <div class="subItem"><a href="inscricao_nova.php">&nbsp;&nbsp;FICHA DE INSCRIÇÃO</a></div>

		<div class="subItem"><a href="galeria_nova.php">&nbsp;&nbsp;GALERIA</a></div>

		<div class="subItem"><a href="equipe_nova.php">&nbsp;&nbsp;EQUIPE...</a></div>

		<div class="subItem"><a href="localizacao_nova.php">&nbsp;&nbsp;LOCALIZAÇÃO</a></div>

		<div class="subItem"><a href="contact_center_nova.php">&nbsp;&nbsp;CONTACT CENTER</a></div>

		<div class="subItem"><a href="videos_nova.php">&nbsp;&nbsp;VIDEOS</a></div>

		<div class="subItem" style=" padding: 2px 0 0 0"><a href="publicacoes_nova.php">&nbsp;&nbsp;PUBLICAÇÕES</a></div>
		...
		<select name="academico" class="menu" style="top: 180px" size="4" id="academico" title="&nbsp;ACADÊMICO" >
            ...
            <div><option value="academico/POMPAGE.pdf">&nbsp;&nbsp;POMPAGE</option></div>
