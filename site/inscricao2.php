                      ...
                      <tr>
                        ...
                        <tr>
                            <td colspan="3"><label>Nome do Curso:</label>
                                <input name="nome_curso" type="text" id="nome_curso" size="30" maxlength="50" />                            </td>
                        </tr>
                        <tr>
                            <td colspan="3"><label>Local do Curso: </label>
                              <input name="local" type="text" id="local" size="30" maxlength="50" />                        </td>
                        </tr>
                        <tr>
                            <td colspan="3"><label>Data de Inscrição: </label>
                                <input name="data2" type="text" id="data2" onkeyup="barra(this)" size="10" maxlength="10" />                            </td>
                        </tr>
                        <tr>
                        	<td>Conheceu o curso atrav&eacute;s de:</td>
                            <td colspan="2"><label>Pesquisa na Internet:</label>
                                <input type="checkbox" name="pesquisa" id="pesquisa" value="internet" />                            </td>
                        </tr>
                        <tr>
                        	<td>&nbsp;</td>
