...
*/
if ($captcha->validate_submit($_POST['image'],$_POST['attempt'])) {
...
$Error = true;
			...
			//	Inclui e estância classe para envio de e-mail
				...
				//	Define destinatário
				$Email->addTo( "henriquecursos@cybernet.com.br" );				
...
/*
	...
	*/
		...
		Header("Location: http://www.henriquecursos.com/site/obrigado.php");
	// 

}else{

	Header("Location: http://www.henriquecursos.com/site/errodeenvio.php");
