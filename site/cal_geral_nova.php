		...
		<table width="570" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			<table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <?php
				...
				elseif ($id == '26'){
					...
					$programa = 'obstetricia_uroginecologia.php';
				...
				elseif ($id == '66'){
					...
					$programa = 'stiper_terapia.php';	
				}
				elseif ($id == '67'){
					
					$programa = 'new_seitai.php';	
				}
				else{
			...
			<tr>
            	...
            	<td><div align="right"><a href="<?=$programa;?>" class="t_titulo_p1"><font class="t_texto f16">PROGRAMA DE CURSO</font></a>&nbsp;&nbsp;</div></td>

            </tr>

                <td align="left"><img src="images/tit_marcador_azul.gif" width="14" height="14" /> <span class="t_titulo">CALENDÁRIO - <?=$output[0]?> <img src="images/marca_reg_azul.gif" width="12" height="12"> - <a href="newslater.php?id=<?=$id?>"><span class="style3">(Avise-me da Pr&oacute;xima turma)</span></a></span></td>
              ...
              <tr>
				...
				<table width="550" border="0" cellpadding="2" cellspacing="1" class="txt_calendario">

                  <tr class="tr_cal">

                    <td style="width: 100px;" align="center"><b>Estado</b></td>
					
					<td style="width: 250px;" align="center"><b>Endereço</b></td>
					
					<td align="center"><b>Horário</b></td>

                    <td style="width: 30px;" align="center"><b>Dia</b></td>

                    <td style="width: 30px;" align="center"><b>M&ecirc;s</b></td>

                    <td align="center"><b>Ano</b></td>

                    <td align="center"><b>Inscri&ccedil;&otilde;es</b></td>
                 ...
                 <?                                                                      
					...
					$mes_abreviados = array("Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez");
                   ...
                   {   $val = $obj->inscricoes;
						...
						$mes_correto = str_ireplace($mes, $mes_abreviados, $obj->mes);
                   	    ...
                   	    echo '<tr bgcolor="#F7F7D4">
							   ...
							   <td>';
								echo ($obj->endereco)?$obj->endereco: "-";
						echo  '</td>
							   <td>';
								echo ($obj->horario)?$obj->horario: "-";
						echo  '</td>
                  			    <td>'.$obj->dia.'</td>
...

                  	 	{
                 	 	     ...
                 	 	     <tr bgcolor="#F7F7D4">
								...
								<td>
									<a href=<?=$obj->link?> onFocus="this.blur()" onClick="NewWindow(this.href,'calendario','483','550','no','center');return false">
										<span class="style3">
											<?php echo($obj->endereco)?$obj->endereco: "-";?>
										</span>
									</a>
								</td>
								...
								<td>
									<a href=<?=$obj->link?> onFocus="this.blur()" onClick="NewWindow(this.href,'calendario','483','550','no','center');return false">
										<span class="style3">
											<?php echo ($obj->horario)?$obj->horario: "-";?>
										</span>
									</a>
								</td>
								...
								<td><a href=<?=$obj->link?> onFocus="this.blur()" onClick="NewWindow(this.href,'calendario','483','550','no','center');return false"><span class="style3"><?=$obj->dia?></span></a></td>
                 				...
                 				<td><a href=<?=$obj->link?> onFocus="this.blur()" onClick="NewWindow(this.href,'calendario','483','550','no','center');return false"><span class="style3"><?=$mes_correto?></span></a></td>
								...
								<td><a href=<?=$obj->link?> onFocus="this.blur()" onClick="NewWindow(this.href,'calendario','483','550','no','center');return false"><span class="txt_calendario style3">ABERTAS</span><br />

								<span class="txt_calendario style3 pisca" style="transition:all 500ms linear; z-index:999;" >[leia mais]<?php if($obj->ano == '2010'){echo $espera;}?></span></a></td>
