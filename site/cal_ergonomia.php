          ...
          <tr>
			...
			<table width="556" border="0" align="center" cellpadding="0" cellspacing="0">
			  ...
			  while($result = mysql_fetch_array($sql2)){
			  	if(($result['nome'] == 'ERGONOMIA - MÓDULO BÁSICO')){
					$id1 = $result['id'];
				}
				elseif(($result['nome'] == 'ERGONOMIA - MÓDULO AVANÇADO')){
					$id2 = $result['id'];
				}
			  }
                  ...
                  <tr>
                    <td colspan="2">
                    	<form method="GET" action="cal_geral.php">
                    		...
                    		<input type="submit" value="MÓDULO BÁSICO"  />
                        </form>
                    </td>
                    <td colspan="3">
                    	<form method="GET" action="cal_geral.php">
                        	<input type="hidden" value="<?=$id2?>" name="id" />
                        	<input type="submit" value="MÓDULO AVANÇADO"  />
                        </form>
                    </td>
                  </tr>
                  <tr >
