		...
		<table width="570" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			<table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="824" align="left" colspan="2">&nbsp;</td>
              </tr>
			  <tr>
                <td height="63" colspan="2"><div align="center">Sua mensagem foi enviada com sucesso! </div></td>
              </tr>
			
			<tr>
				<td height="32" colspan="2">
				  <br>
				  <form name="lkmail" method="post" action="home.php">
				    <div></div>
				    <div>&nbsp;</div>
				    <div>&nbsp;&nbsp;
