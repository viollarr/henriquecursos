          ...
          <tr>
			...
			<table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="462" align="left"><img src="images/tit_marcador_azul.gif" width="14" height="14" /> <span class="t_titulo">GALERIA <img src="images/camera10.gif" alt="" width="102" height="94" /></span></td>
			  ...
			  while($x = mysql_fetch_array($sql)){
				...
				echo "<tr class='t_titulo_p'><td align='center'>".$x['descricao']."</td></tr>";
